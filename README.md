...
(setq oe-follow-symlinks t)
;; Preserve symbolic links when copying (copy link itself, not target content)
(setq oe-copy-symlinks-as-symlinks t)
;; Display link targets in tree view (e.g., "file.txt → /path/to/target")
(setq oe-show-link-targets t)
;; Detect hard links (may slow down large directories)
(setq oe-detect-hardlinks nil)
